...
#export PP_loggers_to_quiet="resources/log_level_override"
...
#export PP_log_level_override_path=resources/log_level_override.json
...
#export PP_resource_path="resources/"

# An override for The path to statistical thresholds
#export PP_threshold_path="resources/thresholds/"

# An override for The path to the application log configuration
#export PP_log_config_path="resources/python_log_config.json

# An override for Where to store intermediate files
#export PP_intermediate_directory="intermediate"
...
#export PP_profile_path="resources/profiles/"
