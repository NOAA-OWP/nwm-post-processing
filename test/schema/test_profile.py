...
class ProfileTest(DataTest):
    ...
    def test_intopython_operation(self):
        logger: logging.Logger = logging.getLogger("test_intopython_operation")
        logger.info("Running test")
        ...
        # TODO: manually load the files to be loaded through the indicated function
        # TODO: Find the load operation, call it, assign the loaded data
        # TODO: Ensure that the manually loaded data matches the data loaded via the operation
    ...
    def test_topython_operation(self):
        logger: logging.Logger = logging.getLogger("test_topython_operation")
        logger.info("Running test")
    ...
    def test_out_of_python_operation(self):
        logger: logging.Logger = logging.getLogger("test_out_of_python_operation")
        logger.info("Running test")
        ...
        # TODO: Find the 'out_of_python_operation"
        # TODO: Find the generated file(s) and ensure they match expectations
